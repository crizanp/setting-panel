            ...
            {activeTab === 'performance' && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  >
                    <RefreshCw className={`w-4 h-4 ${loadingPerformance ? 'animate-spin' : ''}`} />
                    Refresh
                  </button>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-medium text-blue-900">Total Impressions</h4>
                      </div>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg border border-green-200">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-medium text-green-900">Total Clicks</h4>
                      </div>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-medium text-purple-900">CTR</h4>
                      </div>
                      <p className="text-2xl font-bold text-purple-800">
                        {performanceData.ctr ? `${performanceData.ctr.toFixed(2)}%` : '0.00%'}
                      </p>
                    </div>
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h4 className="font-medium text-orange-900">Revenue</h4>
                      </div>
                      <p className="text-2xl font-bold text-orange-800">
                        ${performanceData.revenue?.toFixed(2) || '0.00'}
                      </p>
                    </div>
                  </div>
                ) : (
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex items-center justify-between p-3 bg-white rounded border">
                      <div>
                        <h5 className="font-medium text-gray-900">Click Tracking</h5>
                        <p className="text-sm text-gray-600">Track ad clicks for analytics</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          checked={settings.performance.trackClicks}
                          onChange={(e) => setSettings(prev => ({
                            ...prev,
                            performance: {
                              ...prev.performance,
                    ...
                    <div className="flex items-center justify-between p-3 bg-white rounded border">
                      <div>
                        <h5 className="font-medium text-gray-900">Impression Tracking</h5>
                        <p className="text-sm text-gray-600">Track ad impressions</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          checked={settings.performance.trackImpressions}
                          onChange={(e) => setSettings(prev => ({
                            ...prev,
                            performance: {
                              ...prev.performance,
                    ...
                    <div className="flex items-center justify-between p-3 bg-white rounded border">
                      <div>
                        <h5 className="font-medium text-gray-900">Reporting</h5>
                        <p className="text-sm text-gray-600">Enable detailed reporting</p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          type="checkbox"
                          checked={settings.performance.reportingEnabled}
                          onChange={(e) => setSettings(prev => ({
                            ...prev,
                            performance: {
                              ...prev.performance,
                ...
                {performanceData && performanceData.placementStats && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="text-md font-medium text-gray-900 mb-4">Performance by Placement</h4>
                      ...
                      <table className="w-full bg-white rounded border">
                        <thead className="bg-gray-100">
                          <tr>
                            ...
                            <th className="px-4 py-3 text-left text-sm font-medium text-gray-900">Impressions</th>
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {Object.entries(performanceData.placementStats).map(([placement, stats]) => (
                            <tr key={placement} className="hover:bg-gray-50">
                              <td className="px-4 py-3 text-sm font-medium text-gray-900 capitalize">
                                {placement.replace(/([A-Z])/g, ' $1').trim()}
                              </td>
